...
if (!function_exists('_gdrcd_icon_paths')) {
    ...
    function _gdrcd_icon_paths(): array
    {
        ...
        $paths = [
            ...
            'journal'       => 'M9 12h6m-6 4h6M7 8h10M5 4h10a2 2 0 012 2v14l-3-2-3 2-3-2-3 2V6a2 2 0 012-2z',
            'scroll'        => 'M4 6a2 2 0 012-2h8a2 2 0 012 2v14l-4-2-4 2-4-2-2 1V6z',
            'dice'          => 'M4 4h16v16H4V4z M9 9h.01 M15 9h.01 M9 15h.01 M15 15h.01',
            'sword'         => 'M14.5 9.5L21 3l-2 6.5L14.5 9.5z M14.5 9.5l-9 9m9-9l-2.5-2.5m-6.5 11.5L3 21h2l1.5-1.5',
        ];
        return $paths;
    }
}
