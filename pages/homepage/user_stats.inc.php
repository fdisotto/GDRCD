...
<table class="gdrcd-stat-list">
    <tbody>
    <tr>
        <td><?= gdrcd_filter('out', $MESSAGE['interface']['user']['stats']['creation_date']) ?></td>
        <td><?= gdrcd_format_date($site_activity['date_of_activity']) ?></td>
    </tr>
    <tr>
        <td><?= gdrcd_filter('out', $MESSAGE['interface']['user']['stats']['characters']) ?></td>
        <td><?= (int)$registered_users['num'] ?></td>
    </tr>
    <tr>
        <td><?= gdrcd_filter('out', $MESSAGE['interface']['user']['stats']['exiled']) ?></td>
        <td><?= (int)$banned_users['num'] ?></td>
    </tr>
    <tr>
        <td><?= gdrcd_filter('out', $PARAMETERS['names']['master']['plur']) ?></td>
        <td><?= (int)$master_users['num'] ?></td>
    </tr>
    <tr>
        <td><?= gdrcd_filter('out', $PARAMETERS['names']['moderators']['plur']) ?></td>
        <td><?= (int)$admin_users['num'] ?></td>
    </tr>
    <tr>
        <td><?= gdrcd_filter('out', $MESSAGE['interface']['user']['stats']['topics']) ?></td>
        <td><?= (int)$weekly_posts['num'] ?></td>
    </tr>
    <tr>
        <td><?= gdrcd_filter('out', $MESSAGE['interface']['user']['stats']['last_chat']) ?></td>
        <td><?= (int)$weekly_actions['num'] ?></td>
    </tr>
    <tr>
        <td><?= gdrcd_filter('out', $MESSAGE['interface']['user']['stats']['last_characters']) ?></td>
        <td><?= (int)$weekly_signup['num'] ?></td>
    </tr>
    </tbody>
</table>
