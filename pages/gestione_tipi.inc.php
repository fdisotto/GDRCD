                                    ...
                                    <td class="text-right">
                                        <div class="inline-flex gap-1 justify-end">
                                            <form action="<?= htmlspecialchars($ref_back_url) ?>" method="post" class="inline">
                                                ...
                                                <button type="submit" class="gdrcd-btn-ghost p-1.5" title="<?= gdrcd_filter('out', $MESSAGE['interface']['administration']['ops']['edit']) ?>" aria-label="<?= gdrcd_filter('out', $MESSAGE['interface']['administration']['ops']['edit']) ?>">
                                            ...
                                            <form action="<?= htmlspecialchars($ref_back_url) ?>" method="post" class="inline" onsubmit="return confirm('Eliminare definitivamente?');">
                                                ...
                                                <button type="submit" class="gdrcd-btn-ghost p-1.5 text-gdrcd-error" title="<?= gdrcd_filter('out', $MESSAGE['interface']['administration']['ops']['erase']) ?>" aria-label="<?= gdrcd_filter('out', $MESSAGE['interface']['administration']['ops']['erase']) ?>">
                                                    <svg class="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2" aria-hidden="true"><path stroke-linecap="round" stroke-linejoin="round" d="M19 7l-.867 12.142A2 2 0 0116.138 21H7.862a2 2 0 01-1.995-1.858L5 7m5 4v6m4-6v6M1 7h22m-9 0V4a1 1 0 00-1-1h-4a1 1 0 00-1 1v3"/></svg>
                                                </button>
                                            </form>
                                        </div>
                                    </td>
